<?php
	...
	// Policy Accepted or Declined
	if (isset($_POST['submitted'])) {
		// Determine whether policy has been accepted or not
		...
		// If policy has been accepted, update database, and return to index page
		if ($policy_accepted) {
			$userid = $_SESSION['user_id'];
			$sql = "UPDATE User SET Accepted_Policy = 1 WHERE User_ID = '$userid';";
			@mysqli_query($conn, $sql);
			header('location:index.php');
		} else {
		// If policy has been declined, update database, clear session (logout) and present message on home page
			$userid = $_SESSION['user_id'];
			$sql = "UPDATE User SET Accepted_Policy = 0 WHERE User_ID = '$userid';";
			@mysqli_query($conn, $sql);
			session_destroy();
			header('location:index.php?policy-declined');
		}
	}
...
<html lang="en">
	...
	<body>
		...
		<div id="content">
			...
			<!-- Display Accept/Decline section if logged in, otherwise, only display policy -->
			<?php if (isset($_SESSION['logged_in']) && $_SESSION['admin'] == 0): ?>
			
				<p><i>
				The Canadian Federal Government is introducing a new privacy protection law known as the 'General Data
				Protect Regulation. This law requires all users to give <strong>explicit permission</strong> for their data to be used
				and gives individuals the right to know who is accessing their information and what it is being used
				for.
				</i></p>
				<p><i>
				For your review and confirmation, Iroh's Tea House has provided a comprehensive Privacy Policy below:
				</i></p>
				<br>
				
				<form action="" method="POST">
					<input type="hidden" name="accept">
					<button class="privacy-policy-buttons" type="submit" name="submitted">Accept Privacy Policy</button>
				</form>
				<form action="" method="POST">
					<input type="hidden" name="decline">
					<button class="privacy-policy-buttons" type="submit" name="submitted">Decline Privacy Policy</button>
				</form>
			...
			<p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights in accordance with the General Data Protection Regulation.</p>
			...
			<li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Iroh's Tea House, 42 Main St, Victoria BC.</li>
			...
			<li>Website refers to Iroh's Tea House, accessible from IrohsTeaHouse.com</li>
			...
			<ul>
			<li>Comply with the General Data Protection Regulation</li>
			...
			<ul>
				<li>By email: questions@irohsteahouse.com</li>
			<ul>	
			<br><br>
		</div>
		...
		<footer>
			<div id="contact">
				...
				<a class="Contactbutton">Privacy policy</a>
			</div>
